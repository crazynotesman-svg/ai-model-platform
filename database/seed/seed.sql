...
INSERT OR IGNORE INTO models (slug, provider, model_type, context_window, release_date) VALUES
  ...
  ('openai/gpt-5.5', (SELECT id FROM providers WHERE name = 'OpenAI'), 'chat', 400000, NULL),
  ('openai/gpt-5.4', (SELECT id FROM providers WHERE name = 'OpenAI'), 'chat', 400000, NULL),
  ('anthropic/claude-opus-4.8', (SELECT id FROM providers WHERE name = 'Anthropic'), 'chat', 1000000, NULL),
  ('anthropic/claude-sonnet-4.6', (SELECT id FROM providers WHERE name = 'Anthropic'), 'chat', 200000, NULL),
  ('google/gemini-3.1-pro', (SELECT id FROM providers WHERE name = 'Google'), 'chat', 2000000, NULL),
  ('google/gemini-3.1-flash-lite', (SELECT id FROM providers WHERE name = 'Google'), 'chat', 1048576, NULL),
  ('mistral/mistral-small-4', (SELECT id FROM providers WHERE name = 'Mistral'), 'chat', 128000, '2026-02-25'),
  ('alibaba/qwen3-32b', (SELECT id FROM providers WHERE name = 'Alibaba'), 'chat', 131072, '2025-04-29'),
  ('xai/grok-4', (SELECT id FROM providers WHERE name = 'xAI'), 'chat', 1000000, NULL),
  ('minimax/minimax-m3', (SELECT id FROM providers WHERE name = 'MiniMax'), 'chat', 1000000, '2026-06-01'),
  ('baidu/ernie-4.5-vl-424b', (SELECT id FROM providers WHERE name = 'Baidu'), 'chat', 123000, '2025-06-30'),
  ('tencent/hunyuan-turbos', (SELECT id FROM providers WHERE name = 'Tencent'), 'chat', 256000, '2025-05-21'),
  ('bytedance/doubao-1.5-pro', (SELECT id FROM providers WHERE name = 'ByteDance'), 'chat', 256000, NULL),
  ('moonshot/kimi-k2.6', (SELECT id FROM providers WHERE name = 'Moonshot'), 'chat', 262144, NULL);
...
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) VALUES
  ...
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.5'), 'en', 'GPT-5.5', 'OpenAI''s most advanced model for coding and professional work, with a 400K context window.', '["coding","professional work","complex reasoning","agents"]'),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.5'), 'zh-CN', 'GPT-5.5', 'OpenAI 面向编程与专业工作的最先进模型，400K 上下文。', '["coding","professional work","complex reasoning","agents"]'),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.4'), 'en', 'GPT-5.4', 'OpenAI''s affordable flagship for coding and professional workloads.', '["coding","agents","analysis","chatbot"]'),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.4'), 'zh-CN', 'GPT-5.4', 'OpenAI 高性价比旗舰，面向编程与专业任务。', '["coding","agents","analysis","chatbot"]'),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-opus-4.8'), 'en', 'Claude Opus 4.8', 'Anthropic''s top-tier model for complex agentic coding and enterprise workloads.', '["agentic coding","complex reasoning","enterprise","research"]'),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-opus-4.8'), 'zh-CN', 'Claude Opus 4.8', 'Anthropic 顶级模型，面向复杂智能体编程与企业任务。', '["agentic coding","complex reasoning","enterprise","research"]'),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-sonnet-4.6'), 'en', 'Claude Sonnet 4.6', 'Anthropic''s balanced frontier model with strong reasoning and cost efficiency.', '["reasoning","coding","analysis","tool use"]'),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-sonnet-4.6'), 'zh-CN', 'Claude Sonnet 4.6', 'Anthropic 均衡型前沿模型，推理强且性价比高。', '["reasoning","coding","analysis","tool use"]'),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-pro'), 'en', 'Gemini 3.1 Pro', 'Google''s newest flagship with a 2M context window and advanced reasoning (preview).', '["complex reasoning","coding","long-context","multimodal"]'),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-pro'), 'zh-CN', 'Gemini 3.1 Pro', 'Google 最新旗舰，2M 上下文与高级推理（预览版）。', '["complex reasoning","coding","long-context","multimodal"]'),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-flash-lite'), 'en', 'Gemini 3.1 Flash-Lite', 'Google''s most cost-efficient Gemini 3.1 model for high-volume lightweight tasks.', '["high-volume","classification","lightweight chat","extraction"]'),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-flash-lite'), 'zh-CN', 'Gemini 3.1 Flash-Lite', 'Google 最具性价比的 3.1 模型，适合高吞吐轻量任务。', '["high-volume","classification","lightweight chat","extraction"]'),
  ((SELECT id FROM models WHERE slug = 'mistral/mistral-small-4'), 'en', 'Mistral Small 4', 'Mistral''s fast, affordable model for high-volume and lightweight tasks.', '["high-volume","classification","chatbot","extraction"]'),
  ((SELECT id FROM models WHERE slug = 'mistral/mistral-small-4'), 'zh-CN', 'Mistral Small 4', 'Mistral 的快速实惠模型，适合高并发轻量任务。', '["high-volume","classification","chatbot","extraction"]'),
  ((SELECT id FROM models WHERE slug = 'alibaba/qwen3-32b'), 'en', 'Qwen3 32B', 'Alibaba''s compact MoE model with strong reasoning at very low cost.', '["reasoning","coding","chatbot","multilingual"]'),
  ((SELECT id FROM models WHERE slug = 'alibaba/qwen3-32b'), 'zh-CN', 'Qwen3 32B', '阿里的小型 MoE 模型，超低成本强推理。', '["reasoning","coding","chatbot","multilingual"]'),
  ((SELECT id FROM models WHERE slug = 'xai/grok-4'), 'en', 'Grok 4', 'xAI''s flagship model with a 1M context window and strong reasoning (Grok 4 series).', '["reasoning","coding","chatbot","long-context"]'),
  ((SELECT id FROM models WHERE slug = 'xai/grok-4'), 'zh-CN', 'Grok 4', 'xAI 旗舰模型，1M 上下文与强推理（Grok 4 系列）。', '["reasoning","coding","chatbot","long-context"]'),
  ((SELECT id FROM models WHERE slug = 'minimax/minimax-m3'), 'en', 'MiniMax M3', 'MiniMax''s frontier model with 1M context, native multimodal and agentic coding.', '["coding","agentic workflows","multimodal","long-context"]'),
  ((SELECT id FROM models WHERE slug = 'minimax/minimax-m3'), 'zh-CN', 'MiniMax M3', 'MiniMax 前沿模型：1M 上下文、原生多模态与智能体编程。', '["coding","agentic workflows","multimodal","long-context"]'),
  ((SELECT id FROM models WHERE slug = 'baidu/ernie-4.5-vl-424b'), 'en', 'ERNIE 4.5 VL 424B', 'Baidu''s largest multimodal flagship model with vision and text understanding.', '["multimodal","vision","chatbot","Chinese content"]'),
  ((SELECT id FROM models WHERE slug = 'baidu/ernie-4.5-vl-424b'), 'zh-CN', 'ERNIE 4.5 VL 424B', '百度最大多模态旗舰模型，视觉与文本理解。', '["multimodal","vision","chatbot","Chinese content"]'),
  ((SELECT id FROM models WHERE slug = 'tencent/hunyuan-turbos'), 'en', 'Hunyuan TurboS', 'Tencent''s fast hybrid-thinking model with low latency.', '["chatbot","fast inference","Chinese content","high-volume"]'),
  ((SELECT id FROM models WHERE slug = 'tencent/hunyuan-turbos'), 'zh-CN', '混元 TurboS', '腾讯的快速混合推理模型，低延迟。', '["chatbot","fast inference","Chinese content","high-volume"]'),
  ((SELECT id FROM models WHERE slug = 'bytedance/doubao-1.5-pro'), 'en', 'Doubao 1.5 Pro', 'ByteDance''s flagship chat model with a 256K context window.', '["chatbot","Chinese content","long-context","coding"]'),
  ((SELECT id FROM models WHERE slug = 'bytedance/doubao-1.5-pro'), 'zh-CN', '豆包 1.5 Pro', '字节跳动旗舰对话模型，256K 上下文。', '["chatbot","Chinese content","long-context","coding"]'),
  ((SELECT id FROM models WHERE slug = 'moonshot/kimi-k2.6'), 'en', 'Kimi K2.6', 'Moonshot AI''s newest reasoning model with a 262K context window.', '["reasoning","coding","tool use","long-context"]'),
  ((SELECT id FROM models WHERE slug = 'moonshot/kimi-k2.6'), 'zh-CN', 'Kimi K2.6', '月之暗面最新推理模型，262K 上下文。', '["reasoning","coding","tool use","long-context"]');
...
INSERT OR IGNORE INTO pricing (model_id, input_price, output_price, currency, unit) VALUES
  ...
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.5'), 5.0, 30.0, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.4'), 2.5, 15.0, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-opus-4.8'), 5.0, 25.0, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-sonnet-4.6'), 3.0, 15.0, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-pro'), 2.0, 12.0, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-flash-lite'), 0.25, 1.5, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'mistral/mistral-small-4'), 0.15, 0.6, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'alibaba/qwen3-32b'), 0.1, 0.44, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'xai/grok-4'), 1.25, 2.5, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'minimax/minimax-m3'), 0.3, 1.2, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'baidu/ernie-4.5-vl-424b'), 0.42, 1.25, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'tencent/hunyuan-turbos'), 0.12, 0.3, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'bytedance/doubao-1.5-pro'), 0.12, 0.3, 'USD', 'per_1M_tokens'),
  ((SELECT id FROM models WHERE slug = 'moonshot/kimi-k2.6'), 0.96, 3.99, 'USD', 'per_1M_tokens');
...
INSERT OR IGNORE INTO model_capabilities (model_id, capability, supported) VALUES
  ...
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.5'), 'vision', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.5'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.5'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.5'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.5'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.5'), 'multimodal', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.5'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.4'), 'vision', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.4'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.4'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.4'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.4'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.4'), 'multimodal', 1),
  ((SELECT id FROM models WHERE slug = 'openai/gpt-5.4'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-opus-4.8'), 'vision', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-opus-4.8'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-opus-4.8'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-opus-4.8'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-opus-4.8'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-opus-4.8'), 'multimodal', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-opus-4.8'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-sonnet-4.6'), 'vision', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-sonnet-4.6'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-sonnet-4.6'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-sonnet-4.6'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-sonnet-4.6'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-sonnet-4.6'), 'multimodal', 1),
  ((SELECT id FROM models WHERE slug = 'anthropic/claude-sonnet-4.6'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-pro'), 'vision', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-pro'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-pro'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-pro'), 'audio', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-pro'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-pro'), 'multimodal', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-pro'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-flash-lite'), 'vision', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-flash-lite'), 'reasoning', 0),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-flash-lite'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-flash-lite'), 'audio', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-flash-lite'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-flash-lite'), 'multimodal', 1),
  ((SELECT id FROM models WHERE slug = 'google/gemini-3.1-flash-lite'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'mistral/mistral-small-4'), 'vision', 0),
  ((SELECT id FROM models WHERE slug = 'mistral/mistral-small-4'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'mistral/mistral-small-4'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'mistral/mistral-small-4'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'mistral/mistral-small-4'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'mistral/mistral-small-4'), 'multimodal', 0),
  ((SELECT id FROM models WHERE slug = 'mistral/mistral-small-4'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'alibaba/qwen3-32b'), 'vision', 0),
  ((SELECT id FROM models WHERE slug = 'alibaba/qwen3-32b'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'alibaba/qwen3-32b'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'alibaba/qwen3-32b'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'alibaba/qwen3-32b'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'alibaba/qwen3-32b'), 'multimodal', 0),
  ((SELECT id FROM models WHERE slug = 'alibaba/qwen3-32b'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'xai/grok-4'), 'vision', 1),
  ((SELECT id FROM models WHERE slug = 'xai/grok-4'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'xai/grok-4'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'xai/grok-4'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'xai/grok-4'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'xai/grok-4'), 'multimodal', 1),
  ((SELECT id FROM models WHERE slug = 'xai/grok-4'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'minimax/minimax-m3'), 'vision', 1),
  ((SELECT id FROM models WHERE slug = 'minimax/minimax-m3'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'minimax/minimax-m3'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'minimax/minimax-m3'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'minimax/minimax-m3'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'minimax/minimax-m3'), 'multimodal', 1),
  ((SELECT id FROM models WHERE slug = 'minimax/minimax-m3'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'baidu/ernie-4.5-vl-424b'), 'vision', 1),
  ((SELECT id FROM models WHERE slug = 'baidu/ernie-4.5-vl-424b'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'baidu/ernie-4.5-vl-424b'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'baidu/ernie-4.5-vl-424b'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'baidu/ernie-4.5-vl-424b'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'baidu/ernie-4.5-vl-424b'), 'multimodal', 1),
  ((SELECT id FROM models WHERE slug = 'baidu/ernie-4.5-vl-424b'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'tencent/hunyuan-turbos'), 'vision', 0),
  ((SELECT id FROM models WHERE slug = 'tencent/hunyuan-turbos'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'tencent/hunyuan-turbos'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'tencent/hunyuan-turbos'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'tencent/hunyuan-turbos'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'tencent/hunyuan-turbos'), 'multimodal', 0),
  ((SELECT id FROM models WHERE slug = 'tencent/hunyuan-turbos'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'bytedance/doubao-1.5-pro'), 'vision', 0),
  ((SELECT id FROM models WHERE slug = 'bytedance/doubao-1.5-pro'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'bytedance/doubao-1.5-pro'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'bytedance/doubao-1.5-pro'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'bytedance/doubao-1.5-pro'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'bytedance/doubao-1.5-pro'), 'multimodal', 0),
  ((SELECT id FROM models WHERE slug = 'bytedance/doubao-1.5-pro'), 'long_context', 1),
  ((SELECT id FROM models WHERE slug = 'moonshot/kimi-k2.6'), 'vision', 0),
  ((SELECT id FROM models WHERE slug = 'moonshot/kimi-k2.6'), 'reasoning', 1),
  ((SELECT id FROM models WHERE slug = 'moonshot/kimi-k2.6'), 'coding', 1),
  ((SELECT id FROM models WHERE slug = 'moonshot/kimi-k2.6'), 'audio', 0),
  ((SELECT id FROM models WHERE slug = 'moonshot/kimi-k2.6'), 'function_calling', 1),
  ((SELECT id FROM models WHERE slug = 'moonshot/kimi-k2.6'), 'multimodal', 0),
  ((SELECT id FROM models WHERE slug = 'moonshot/kimi-k2.6'), 'long_context', 1);
