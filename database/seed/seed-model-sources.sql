...
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) SELECT id, 'ko', 'Gemini 3 Flash Lite', 'Gemini 3 Flash Lite fast model', '[]' FROM models WHERE slug = 'google/gemini-3-flash-lite';
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) SELECT id, 'es', 'Gemini 3 Flash Lite', 'Gemini 3 Flash Lite fast model', '[]' FROM models WHERE slug = 'google/gemini-3-flash-lite';
...
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) SELECT id, 'ko', 'Qwen2.5 14B', 'Qwen2.5 14B open model', '[]' FROM models WHERE slug = 'alibaba/qwen2.5-14b';
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) SELECT id, 'es', 'Qwen2.5 14B', 'Qwen2.5 14B open model', '[]' FROM models WHERE slug = 'alibaba/qwen2.5-14b';
...
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) SELECT id, 'ko', 'Kimi K2 Turbo', 'Kimi K2 Turbo efficient model', '[]' FROM models WHERE slug = 'moonshot/kimi-k2-turbo';
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) SELECT id, 'es', 'Kimi K2 Turbo', 'Kimi K2 Turbo efficient model', '[]' FROM models WHERE slug = 'moonshot/kimi-k2-turbo';
...
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) SELECT id, 'ko', 'Grok 3 Mini', 'Grok 3 Mini efficient model', '[]' FROM models WHERE slug = 'xai/grok-3-mini';
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) SELECT id, 'es', 'Grok 3 Mini', 'Grok 3 Mini efficient model', '[]' FROM models WHERE slug = 'xai/grok-3-mini';
...
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) SELECT id, 'ko', 'Hunyuan Lite', 'Hunyuan Lite efficient model', '[]' FROM models WHERE slug = 'tencent/hunyuan-lite';
INSERT OR IGNORE INTO model_translations (model_id, language, name, description, use_cases) SELECT id, 'es', 'Hunyuan Lite', 'Hunyuan Lite efficient model', '[]' FROM models WHERE slug = 'tencent/hunyuan-lite';
